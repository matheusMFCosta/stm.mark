...
Object.defineProperty(exports, "__esModule", { value: true });
const dotenv = __webpack_require__(19);
const express = __webpack_require__(1);
const path = __webpack_require__(20);
dotenv.config();
const item_controller_1 = __webpack_require__(21);
...
router.route("/floatValue").get((_, response) => __awaiter(this, void 0, void 0, function* () {
...
router.route("/:id").get((_, response) => __awaiter(this, void 0, void 0, function* () {
    ...
    for (const key of lines) {
        if (key.includes("var g_rgListingInfo")) {
            const itemsData = JSON.parse(key
                .split(" = ")[1]
                .trim()
                .slice(0, -1));
