/******/ (function(modules) {
  ...
  /******/ [
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var debug = __webpack_require__(38)("follow-redirects");
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const app_1 = __webpack_require__(19);
      const url =
        process.env.MONGODB_URI || "mongodb+srv://stm-market:1q2w3e4r5t6Y@cluster0-ouvyr.mongodb.net/test?retryWrites=true&w=majority";
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      dotenv.config();
      const item_controller_1 = __webpack_require__(22);
      const items_controller_1 = __webpack_require__(43);
      const app = express();
      app.use("/api/getItemData", item_controller_1.default);
      app.use("/api/getItemsData", items_controller_1.default);
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      router.route("/floatValue").get((_, response) =>
        __awaiter(this, void 0, void 0, function*() {
          const itemData = yield axios_1.default.get(`https://api.csgofloat.com/?${new URLSearchParams(_.query).toString()}`);
          return response.status(200).send(itemData.data);
        })
      );
      router.route("/:id").get((_, response) => __awaiter(this, void 0, void 0, function*() {}));
      router.route("/").post(bodyParser.json(), (request, response) =>
        __awaiter(this, void 0, void 0, function*() {
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      const axios_1 = __webpack_require__(5);
      const router = express.Router();
      router.route("/:id").get((_, response) =>
        __awaiter(this, void 0, void 0, function*() {
          try {
            const itemId = encodeURIComponent(_.params.id);
            const axiosResponse = yield axios_1.default.get(
